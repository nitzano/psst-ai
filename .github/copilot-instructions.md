...
- After adding a new scanner
  - run pnpm changeset to add a new minor version change. 
    - use the "[SCANNER] " prefix and the scanner name in the changeset title + description.
    - add an output example after the description.
